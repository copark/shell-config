...
hi CursorColumn guifg=NONE    guibg=#111111 gui=none term=none     cterm=none    ctermfg=NONE ctermbg=grey
hi CursorLine   guifg=NONE    guibg=#111111 gui=none term=none     cterm=none    ctermfg=NONE ctermbg=grey
" Specific for c {{{1
